        ...
        >
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="overflow-hidden bg-white shadow-md rounded-lg dark:bg-gray-800 p-6">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
                            <div
                                ...
                                style={{ width: `${getPercentage(myPendingTasks, totalPendingTasks)}%` }}
                            />
                        </div>
                    </div>
                    ...
                    {/* In Progress Tasks */}
                    <div className="overflow-hidden bg-white shadow-md rounded-lg dark:bg-gray-800 p-6">
                        <h3 className="text-blue-500 text-xl font-semibold">In Progress</h3>
                        <p className="text-2xl mt-4 text-gray-800 dark:text-white">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
                            <div
                                ...
                                style={{ width: `${getPercentage(myProgressTasks, totalProgressTasks)}%` }}
                            />
                        </div>
                    </div>
                    ...
                    {/* Completed Tasks */}
                    <div className="overflow-hidden bg-white shadow-md rounded-lg dark:bg-gray-800 p-6">
                        <h3 className="text-green-500 text-xl font-semibold">Completed</h3>
                        <p className="text-2xl mt-4 text-gray-800 dark:text-white">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
                            <div
                                ...
                                style={{ width: `${getPercentage(myCompletedTasks, totalCompletedTasks)}%` }}
                            />
                        </div>
                    </div>
                </div>
